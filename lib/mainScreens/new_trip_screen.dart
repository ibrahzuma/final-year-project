...
class _NewTripScreenState extends State<NewTripScreen> {
  ...
  Future<void> drawPolyLineFromOriginToDestination(LatLng originLatLng) async {
    showDialog(
      context: context,
      builder: (BuildContext context) => ProgressDialog(
        message: "Please wait...",
    ...
    if (originLatLng.latitude > originLatLng.latitude &&
        originLatLng.longitude > originLatLng.longitude) {
      boundsLatLng =
          LatLngBounds(southwest: originLatLng, northeast: originLatLng);
    } else if (originLatLng.longitude > originLatLng.longitude) {
      boundsLatLng = LatLngBounds(
        southwest: LatLng(originLatLng.latitude, originLatLng.longitude),
        northeast: LatLng(originLatLng.latitude, originLatLng.longitude),
      );
  ...
  updateDurationTimeAtRealTime() async {
    if (isRequestDirectionDetails == false) {
      ...
      {
        destinationLatLng =
            widget.userRideRequestDetails!.originLatLng; //user DropOff Location
      }
        ...
        children: [
          ...
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller) {
              ...
              //     driverCurrentLatLng, originLatLng!);
                    ...
                    ElevatedButton.icon(
                      onPressed: () async {
                        ...
                        //[user has already sit in driver's car. Driver start trip now] - Lets Go Button
                          ...
                          setState(() {
                            buttonTitle = "Finished"; //end the trip
